        ...
        <div className="fixed inset-0 z-[250] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in">
            <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden scale-in-center">
                ...
                <div className="p-6 space-y-3">
                    <p className="text-xs text-slate-500 mb-4 text-center">Select a format to save this document offline.</p>
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-[10px] text-slate-500">Best for printing & sharing</p>
                                </div>
                            </div>
                            <div className="bg-white px-2 py-1 rounded text-[10px] font-bold text-slate-400 border border-slate-100">.pdf</div>
                        </button>
                    )}
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-[10px] text-slate-500">Best for offline viewing</p>
                                </div>
                            </div>
