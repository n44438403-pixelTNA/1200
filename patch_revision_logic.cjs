...
const revisionLogicContent = `import React from 'react';
...
fs.writeFileSync('components/admin/RevisionLogicPanel.tsx', revisionLogicContent);
console.log('RevisionLogicPanel.tsx created');
