                    ...
                    <div key={group.key} className={`rounded-2xl border-2 transition-all duration-300 overflow-hidden ${isExpanded ? `bg-white border-${group.color}-100 shadow-sm` : 'bg-white border-slate-100 hover:border-slate-200'}`}>
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <div className={`p-2 rounded-xl transition-colors ${isExpanded ? `bg-white text-${group.color}-600 shadow-sm` : `bg-slate-100 text-slate-500 group-hover:bg-slate-200`}`}>
                                ...
                                <span className={`text-[10px] px-2 py-0.5 rounded-full font-bold ${isExpanded ? `bg-${group.color}-200 text-${group.color}-800` : 'bg-slate-100 text-slate-400'}`}>
