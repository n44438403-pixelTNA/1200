                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="flex-1">
                                                            ...
                                                            <p className="text-xs text-slate-500">
                                                                {log.type === 'PURCHASE' ? 'Transaction' : log.type === 'GAME' ? 'Play Zone' : log.subject} • {log.timestamp ? new Date(log.timestamp).toLocaleDateString() : 'Unknown Date'}
                                                            </p>
                                ...
                                <div className="p-3 flex justify-between items-start">
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center gap-4 text-xs text-slate-400 mt-1">
                                            <div className="flex items-center gap-1"><Calendar size={12} /> {item.dateCreated ? new Date(item.dateCreated).toLocaleDateString() : 'Unknown Date'}</div>
