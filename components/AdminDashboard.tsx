                  ...
                  {activeTab === 'CONFIG_SECURITY' && (
                      <>
                          ...
                          <div className="flex items-center justify-between bg-blue-50 p-4 rounded-xl border border-blue-100 mt-4">
                              <div><p className="font-bold text-blue-800">Enable Logout Button</p><p className="text-xs text-blue-600">If disabled, students cannot see the logout button.</p></div>
